...
class menu:
    ...
    def canvases(self,images):
        ...
        #photo2 = ImageTk.PhotoImage(Image.open(images).resize((w, h)),Image.LANCZOS)
    ...
    def search(self):
        ...
        b1=Button(self.f1,text='Search',bg='orange',font='Papyrus 10 bold',width=9,bd=2,command=self.search1).place(x=500,y=37)
...
def Database():
    ...
    if cursor.fetchone() is None:
        cursor.execute("INSERT INTO `login` (username, password) VALUES('ramya', 'root')")
        conn.commit()
